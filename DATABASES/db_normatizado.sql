...
-- Cria a tabela de Cursos
    CREATE TABLE cursos(
        ...
        FOREIGN KEY(id_professor) REFERENCES professores(id_professor) ON UPDATE CASCADE ON DELETE NO ACTION,
...
-- Cria a tabela de Alunos
    CREATE TABLE alunos(
        ...
        FOREIGN KEY(id_curso) REFERENCES cursos(id_curso) ON UPDATE CASCADE ON DELETE NO ACTION,
